...
def test_get_column_type_renamed():
    ...
    assert get_column_type(version_list=versions, table_name="table", column_name="col") == "DATE"
...
def test_get_column_type_multiple_renamed():
    ...
    assert get_column_type(version_list=versions, table_name="table", column_name="col") == "JSON"
