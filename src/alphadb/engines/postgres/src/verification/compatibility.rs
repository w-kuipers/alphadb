...
use alphadb_core::{
    ...
    verification::{
        compatibility::{check_column_attributes_compatibility, verify_column_type_compatibility, ColumnCompatibilityRule},
...
pub const SUPPORTED_COLUMN_TYPES: [&str; 15] = ["SERIAL", "INTEGER", "SMALLINT", "BIGINT", "TEXT", "TEXT", "REAL", "NUMERIC", "VARCHAR", "TIMESTAMP", "JSONB", "BOOLEAN", "DATE", "TIMESTAMPTZ", "UUID"];
...
/// All the PostgreSQL column types that allow a decimal length value
pub const ALLOW_DECIMAL_LENGTH: [&str; 1] = ["numeric"];
